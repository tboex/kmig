  ...
  return (
    <footer className="w-full h-30 px-4  bg-serika-dark--bg-color flex items-center justify-between z-50">
        ...
        <div className="flex flex-row items-center space-x-6">
            <button className="contactButton flex flex-row items-center space-x-2 text-serika-dark--sub-color hover:text-serika-dark--text-color">
                <i className="fas fa-fw fa-envelope"></i>
                <div>contact</div>
            </button>
            <button className="supportButton flex flex-row items-center space-x-2 text-serika-dark--sub-color hover:text-serika-dark--text-color">
            ...
            <a href="/terms-of-service" className="flex flex-row items-center space-x-2 text-serika-dark--sub-color hover:text-serika-dark--text-color">
